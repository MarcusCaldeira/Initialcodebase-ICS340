...
**/
  public Prog340() {
	...
	inputFile = null;
   	...
   	comboBoxList[1] = new String("Deliv A:  TSP Method A");
   	comboBoxList[2] = new String("Deliv B:  TSP Method B");
   	comboBoxList[3] = new String("Deliv C:  TSP Method C");
   	comboBoxList[4] = new String("Deliv D:  TSP Method D");
